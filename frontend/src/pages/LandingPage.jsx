    ...
    return (
        <div className="bg-amber-50 text-gray-800">
            ...
            <header className="text-center py-16 bg-amber-100 shadow-md">
                ...
                <button onClick={() => navigate("/login")} className="mt-6 bg-amber-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-amber-700 transition">
                    Get Started
                </button>
            </header>
            ...
            <section className="text-center py-16 bg-amber-600 text-white">
                ...
                <button onClick={() => navigate("/login")} className="mt-6 bg-white text-amber-600 px-6 py-3 rounded-lg shadow-md hover:bg-gray-200 transition">
                    Get Started
                </button>
            </section>
