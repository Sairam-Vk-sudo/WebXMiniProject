    ...
    <div className="min-h-screen bg-amber-50">
      ...
      <div className="flex justify-center mt-4">
        <input
          ...
          className="w-2/3 md:w-1/3 p-2 border-2 border-amber-700 bg-white text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-700 shadow-md"
        />
      </div>
